...
private:
  ...
  */
  ...
  static WORD StringToVKey(char* KeyString, int &idx);
  void KeyboardEvent(BYTE VKey, BYTE ScanCode, LONG Flags);

public:

  bool SendKeys(char* KeysString, bool Wait = false);
  //static bool AppActivate(HWND wnd);
  //static bool AppActivate(char* WindowTitle, char* WindowClass = 0);
